...
INSERT INTO `sujets_bac` (`Année`,`Série`,`Lieu`,`Session`,`Sujet`)
VALUES
...
(2021,'GÉN.','AMÉRIQUE LATINE DU NORD','NORMALE','Connaître le passé est-ce préparer l''avenir ?'),
(2022,'GÉN.','ANTILLES-GUYANE','NORMALE','La science a-t-elle toujours raison ?'),
(2022,'GÉN.','ANTILLES-GUYANE','NORMALE','Le langage ne sert-il qu''à communiquer ?'),
(2022,'GÉN.','CENTRES ÉTRANGERS GROUPE 1','NORMALE','Le bonheur nous échappe-t-il inévitablement ?'),
(2022,'GÉN.','CENTRES ÉTRANGERS GROUPE 1','NORMALE','N''y a-t-il de foi que religieuse ?'),
(2022,'GÉN.','ASIE','NORMALE','L’homme est-il une exception dans la nature ?'),
(2022,'GÉN.','ASIE','NORMALE','Toute prise de conscience est-elle libératrice ?'),
(2022,'GÉN.','AMÉRIQUE DU NORD','NORMALE','La conscience fait-elle obstacle au bonheur ?'),
(2022,'GÉN.','AMÉRIQUE DU NORD','NORMALE','La technique permet-elle de ne plus avoir peur de la nature ?'),
(2022,'GÉN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','NORMALE','Les pratiques artistiques transforment-elles le monde ?'),
(2022,'GÉN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','NORMALE','Revient-il à l’État de décider de ce qui est juste ?'),
(2022,'GÉN.','POLYNÉSIE','NORMALE','La science ne fournit-elle que des certitudes ?'),
(2022,'GÉN.','POLYNÉSIE','NORMALE','L’inconscience est-elle un défaut ?'),
(2022,'GÉN.','NOUVELLE-CALÉDONIE','REMPLACEMENT','Le travail est-il une marchandise comme les autres ?'),
(2022,'GÉN.','NOUVELLE-CALÉDONIE','REMPLACEMENT','Y a-t-il des vérités intemporelles ?'),
(2022,'GÉN.','AMÉRIQUE DU SUD','REMPLACEMENT','Puis-je ignorer mes propres pensées ?'),
(2022,'GÉN.','AMÉRIQUE DU SUD','REMPLACEMENT','La justice met-elle fin à la loi du plus fort ?'),
(2022,'GÉN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','REMPLACEMENT','Le droit est-il la mesure des actions justes et injustes ?'),
(2022,'GÉN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','REMPLACEMENT','Les objets techniques satisfont-ils nos besoins ?'),
(2022,'GÉN.','ANTILLES-GUYANE','REMPLACEMENT','Le langage peut-il exprimer ce que nous vivons ?'),
(2022,'GÉN.','ANTILLES-GUYANE','REMPLACEMENT','La science est-elle au service de notre liberté ?'),
(2022,'GÉN.','POLYNÉSIE','REMPLACEMENT','Peut-on dire d’une œuvre d’art qu’elle est vraie ?'),
(2022,'GÉN.','POLYNÉSIE','REMPLACEMENT','L’État a-t-il le devoir de nous protéger ?'),
(2022,'TECHN.','ANTILLES-GUYANE','NORMALE','Avons-nous des devoirs envers la nature ?'),
(2022,'TECHN.','ANTILLES-GUYANE','NORMALE','Pourquoi demander justice ?'),
(2022,'TECHN.','CENTRES ÉTRANGERS GROUPE 1','NORMALE','Faut-il préférer le naturel à l’artificiel ?'),
(2022,'TECHN.','CENTRES ÉTRANGERS GROUPE 1','NORMALE','Suffit-il de connaître la vérité pour nous débarrasser de nos préjugés ?'),
(2022,'TECHN.','ASIE','NORMALE','Pourrions-nous nous passer des machines ?'),
(2022,'TECHN.','ASIE','NORMALE','La vérité doit-elle être partagée ?'),
(2022,'TECHN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','NORMALE','La liberté consiste-t-elle à n''obéir à personne ?'),
(2022,'TECHN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','NORMALE','Est-il juste de défendre ses droits par tous les moyens ?'),
(2022,'TECHN.','POLYNÉSIE','NORMALE','La nature peut-elle être détruite ?'),
(2022,'TECHN.','POLYNÉSIE','NORMALE','Les œuvres d’art permettent-elles de rendre les hommes meilleurs ?'),
(2022,'TECHN.','NOUVELLE-CALÉDONIE','REMPLACEMENT','S’engager, est-ce renoncer à sa liberté ?'),
(2022,'TECHN.','NOUVELLE-CALÉDONIE','REMPLACEMENT','La nature est-elle à notre disposition ?'),
(2022,'TECHN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','REMPLACEMENT','L’activité technique fait-elle violence à la nature ?'),
(2022,'TECHN.','MÉTROPOLE, MAYOTTE, LA RÉUNION','REMPLACEMENT','Des inégalités peuvent-elles être justes ?'),
(2022,'TECHN.','ANTILLES-GUYANE','REMPLACEMENT','Respecter la nature, est-ce renoncer à la transformer ?'),
(2022,'TECHN.','ANTILLES-GUYANE','REMPLACEMENT','Peut-on accepter l’injustice ?'),
(2022,'TECHN.','POLYNÉSIE','REMPLACEMENT','Peut-on se mettre d’accord sur ce qui est juste ?'),
(2022,'TECHN.','POLYNÉSIE','REMPLACEMENT','Transformer la nature nous rend-il plus libres ?');
